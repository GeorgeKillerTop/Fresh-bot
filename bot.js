...
**Now playing:** ${serverQueue.songs[0].title}
        ...
        case "help" :
            ...
            .addField("Add Fresh on your server", '> https://discordapp.com/api/oauth2/authorize?client_id=451067092523941907&permissions=8&scope=bot')
            .setTimestamp();
        ...
        case "sexy":  
            ...
            .setColor("#15f153")
            .addField("Sanse", message.author.username + " este sexy in proportie de 100%")
            .setTimestamp();
            ...
            .setTimestamp();
            return message.channel.sendMessage(E17); 
	    }
            break;     
        case "mute": 
